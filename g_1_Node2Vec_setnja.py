...
def compute_node2vec_embeddings(M, k=EMBED_DIM):
    G = nx.Graph()
    for i in range(1, 40):
        G.add_node(i)
    for i in range(1, 40):
...
def main():
    ...
    emb = compute_node2vec_embeddings(M, k=EMBED_DIM)
    ...
    print()
    print("Predikcija (Node2Vec + kvantna regresija, deterministički, strukturno):")
    print(best_combo)
    print()
    """
    Predikcija (Node2Vec + kvantna regresija, deterministički, strukturno):
    (8, 11, x, y, z, 34, 38)
    """
...
"""
Computing transition probabilities: 100%|█| 39/39 [00:00<00:00, 7
Generating walks (CPU: 1): 100%|█| 80/80 [00:00<00:00, 920.18it/s
"""
